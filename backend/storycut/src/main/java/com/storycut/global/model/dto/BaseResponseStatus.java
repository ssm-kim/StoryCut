...
public enum BaseResponseStatus {
    ...
    INVALID_JWT_TOKEN(false, HttpStatus.UNAUTHORIZED, 1002, "유효하지 않은 JWT 토큰입니다."),
    JWT_ACCESS_TOKEN_EXPIRED(false, HttpStatus.UNAUTHORIZED, 1003, "JWT Access Token이 만료되었습니다."),
    TOKEN_VERIFICATION_FAILED(false, HttpStatus.UNAUTHORIZED, 1004, "토큰 검증에 실패했습니다."),
    USER_NOT_FOUND(false, HttpStatus.NOT_FOUND, 1005, "사용자를 찾을 수 없습니다."),
    TOKEN_GENERATION_FAILED(false, HttpStatus.INTERNAL_SERVER_ERROR, 1006, "토큰 생성에 실패했습니다."),
    REFRESH_TOKEN_INVALID(false, HttpStatus.UNAUTHORIZED, 1007, "유효하지 않은 리프레시 토큰입니다."),
    GOOGLE_ACCESS_TOKEN_EXPIRED(false, HttpStatus.UNAUTHORIZED, 1008, "구글 액세스 토큰이 만료되었습니다."),
