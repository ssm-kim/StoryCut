package com.stroycut.domain.room.service;
...
public interface RoomService {
     ...
     * @throws com.stroycut.global.exception.InvalidValueException 유효하지 않은 요청 값이 있는 경우
     */
     ...
     * @throws com.stroycut.global.exception.BusinessException 해당 공유방이 존재하지 않거나 방장이 아닌 경우
     */
     ...
     * @throws com.stroycut.global.exception.BusinessException 해당 공유방이 존재하지 않거나 방장이 아닌 경우
     * @throws com.stroycut.global.exception.BusinessException 이미 참여 중인 멤버인 경우
     */
     ...
     * @throws com.stroycut.global.exception.BusinessException 해당 공유방이 존재하지 않는 경우
     * @throws com.stroycut.global.exception.BusinessException 비밀번호가 일치하지 않는 경우
     */
