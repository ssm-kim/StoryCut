...
| 기능 | 설명 |
|:---:|:---|
| **프롬프트 기반 영상 컷 편집** | 사용자의 프롬프트를 분석하여 원하는 영상 구간을 자동으로 추출 |
| **유튜브 파이프라인** | 완성된 영상을 유튜브에 자동 업로드 |
| **영상 공간 공유** | 완성된 영상을 지인과 공유할 수 있는 공간 제공 |
| **선택적 인물 모자이크** | 지정한 특정 인물을 제외한 나머지 인물 자동 모자이크 처리 |
